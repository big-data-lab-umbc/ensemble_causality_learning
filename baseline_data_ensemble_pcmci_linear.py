...
import numpy as np
import pcmci_linear_baseline_ensemble
...
for local_pcmci in range(0, num_partitions):
    res_pcmci = pcmci_linear_baseline_ensemble.pcmci_causality(split_arr[local_pcmci], dt, local_pcmci, header, t, n, maxlag)
...
with open("baseline_data_ensemble_pcmci_linear.csv", "w", newline="") as f:
    writer = csv.writer(f)
