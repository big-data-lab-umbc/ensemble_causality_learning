...
spark = SparkSession \
    .builder \
    .appName("two_phase_data_algorithm") \
    .getOrCreate()
...
res_pcmci = pcmci_para.run_pcmci(maxlag, rdd, header, dt, t, n)
...
with open('data_algorithm_ensemble_final_res.csv', 'w') as f:  # Just use 'w' mode in 3.x
