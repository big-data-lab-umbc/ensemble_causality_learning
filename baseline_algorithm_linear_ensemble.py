...
res_pcmci = pcmci_linear_baseline_ensemble.pcmci_causality(data_ori, dt, 0, header, t, n, maxlag)
...
with open('baseline_algorithm_linear_ensemble.csv', 'w') as f:  # Just use 'w' mode in 3.x
